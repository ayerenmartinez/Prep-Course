...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  devolverPrimerElemento =array[array.length-1];
  return devolverPrimerElemento;
}
...
function multiplicarArgumentos() {//En este ejercicio los argumentos (son los parametros de la función)
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  let cantValoresMayor18=0;
  for(let i=0;i<arreglo.length;i++){
    if(arreglo[i]>18){
      cantValoresMayor18++;
    }
  }
  return cantValoresMayor18;
}
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  if(!Array.isArray(arreglo)){//Si no es un arreglo
